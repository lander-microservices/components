          ...
          <div className="row">
            ...
            <div className="footer-links color-dark-grey col">
              <div className="copyright">
                <div className="font-13">Copyright © 2022 | Health benefits</div>
              </div>
              <div className="policylink">
                <ul>
                  <li className="font-13"><a target="_blank" href="https://quotes.health-benefits.co/privacy-policy">PRIVACY POLICY</a></li>
                  <li className="font-13"><a target="_blank" href="https://quotes.health-benefits.co/terms">TERMS OF USE</a></li>
                </ul>
              </div>
            </div>
          </div>
